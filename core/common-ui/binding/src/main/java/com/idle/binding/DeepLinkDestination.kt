...
sealed class DeepLinkDestination(val addressRes: Int) {
    ...
    data object CenterVerification : DeepLinkDestination(R.string.center_verification_deeplink_url)
    ...
    data object WorkerJobDetail : DeepLinkDestination(R.string.worker_job_detail_deeplink_url)
