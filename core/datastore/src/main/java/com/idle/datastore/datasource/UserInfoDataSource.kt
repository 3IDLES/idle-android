...
class UserInfoDataSource @Inject constructor(
    ...
    suspend fun getLocalCenterProfile(): Result<CenterProfile> = runCatching {
        ...
        CenterProfile(
            centerName = properties["centerName"] ?: throw NullPointerException("Missing centerName"),
            officeNumber = properties["officeNumber"] ?: throw NullPointerException("Missing officeNumber"),
            roadNameAddress = properties["roadNameAddress"] ?: throw NullPointerException("Missing roadNameAddress"),
            lotNumberAddress = properties["lotNumberAddress"] ?: throw NullPointerException("Missing lotNumberAddress"),
            detailedAddress = properties["detailedAddress"] ?: throw NullPointerException("Missing detailedAddress"),
            longitude = properties["longitude"]?.toDoubleOrNull() ?: throw NullPointerException("Invalid longitude format"),
            latitude = properties["latitude"]?.toDoubleOrNull() ?: throw NullPointerException("Invalid latitude format"),
    ...
    suspend fun getLocalWorkerProfile(): Result<WorkerProfile> = runCatching {
        ...
        WorkerProfile(
            ...
            workerName = properties["workerName"] ?: throw NullPointerException("Missing workerName"),
            ...
            phoneNumber = properties["phoneNumber"] ?: throw NullPointerException("Missing phoneNumber"),
            roadNameAddress = properties["roadNameAddress"] ?: throw NullPointerException("Missing roadNameAddress"),
            lotNumberAddress = properties["lotNumberAddress"] ?: throw NullPointerException("Missing lotNumberAddress"),
