...
abstract class Hilt_CenterSignUpFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CenterSignUpFragment() {
    super();
  }

  Hilt_CenterSignUpFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CenterSignUpFragment_GeneratedInjector) this.generatedComponent()).injectCenterSignUpFragment(UnsafeCasts.<CenterSignUpFragment>unsafeCast(this));
    }
  }
