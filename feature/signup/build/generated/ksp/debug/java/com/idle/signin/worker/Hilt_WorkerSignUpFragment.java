...
abstract class Hilt_WorkerSignUpFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WorkerSignUpFragment() {
    super();
  }

  Hilt_WorkerSignUpFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerSignUpFragment_GeneratedInjector) this.generatedComponent()).injectWorkerSignUpFragment(UnsafeCasts.<WorkerSignUpFragment>unsafeCast(this));
    }
  }
