...
abstract class Hilt_WorkerRecruitmentDetailFragment extends BaseComposeFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerRecruitmentDetailFragment_GeneratedInjector) this.generatedComponent()).injectWorkerRecruitmentDetailFragment(UnsafeCasts.<WorkerRecruitmentDetailFragment>unsafeCast(this));
    }
  }
