...
abstract class Hilt_WorkerSignInFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WorkerSignInFragment() {
    super();
  }

  Hilt_WorkerSignInFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerSignInFragment_GeneratedInjector) this.generatedComponent()).injectWorkerSignInFragment(UnsafeCasts.<WorkerSignInFragment>unsafeCast(this));
    }
  }
