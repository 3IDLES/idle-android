...
abstract class Hilt_CenterSignInFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CenterSignInFragment() {
    super();
  }

  Hilt_CenterSignInFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CenterSignInFragment_GeneratedInjector) this.generatedComponent()).injectCenterSignInFragment(UnsafeCasts.<CenterSignInFragment>unsafeCast(this));
    }
  }
